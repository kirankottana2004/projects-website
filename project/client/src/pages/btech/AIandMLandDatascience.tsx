...
const allProjects = [
  {
    id: 1,
    title: 'Face mask Detection using openCV and Keras',
  ...
  {
    id: 6,
    title: 'Real time object detection using YOLO v5',
...
export default AIandMLandDatascience;
