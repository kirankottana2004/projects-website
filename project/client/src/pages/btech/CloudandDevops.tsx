...
const allProjects = [
  {
    id: 1,
    title: 'MERN App Deployed with Docker & Nginx',
  ...
  {
    id: 2,
    title: '2. CI/CD Pipeline for React App with GitHub Actions',
  ...
  {
    id: 3,
    title: 'Portfolio Website with Firebase Hosting',
  ...
  {
    id: 4,
    title: 'File Backup System to AWS S3 using Python Boto3',
  ...
  {
    id: 5,
    title: 'Blog Website on EC2 with Nginx & GitHub Integration',
  ...
  {
    id: 6,
    title: 'Realtime Weather App with Cloud Functions (GCP)',
