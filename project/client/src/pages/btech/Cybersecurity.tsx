...
const allProjects = [
  ...
  {
    id: 2,
    title: 'Keylogger Detection Tool (Python GUI)',
  ...
  {
    id: 3,
    title: 'SQL Injection Vulnerability Demonstrator',
  ...
  {
    id: 4,
    title: 'S4. Secure Login System with OTP (PHP + MySQL)',
  ...
  {
    id: 5,
    title: 'Wireshark Traffic Analysis Report',
  ...
  {
    id: 6,
    title: 'Password Manager CLI (Python + Cryptography)',
