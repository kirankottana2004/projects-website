...
const allProjects = [
  {
    id: 1,
    title: 'Inventory Management System using MYSQL',
  ...
  {
    id: 3,
    title: 'Online survey and results dashboard',
  ...
  {
    id: 5,
    title: 'Library system with book search and filters',
  ...
  {
    id: 6,
    title: 'Custumer Review aggregator using Neo 4g',
