...
const allProjects = [
  {
    id: 1,
    title: 'Smart Dustbin using Ultrasonic Sensor & Arduino',
  ...
  {
    id: 2,
    title: 'IoT-Based Home Automation using NodeMCU',
  ...
  {
    id: 4,
    title: 'RFID Attendance System with LCD Display',
  ...
  {
    id: 5,
    title: 'Heartbeat Sensor Monitoring with Raspberry Pi',
  ...
  {
    id: 6,
    title: 'IoT Door Lock System Controlled by Google Assistant',
