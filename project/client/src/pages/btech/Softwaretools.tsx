...
const allProjects = [
  {
    id: 1,
    title: 'API Testing Dashboard using Postman Collections',
  ...
  {
    id: 2,
    title: 'UI Design Kit using Figma for a Fintech App',
  ...
  {
    id: 3,
    title: 'Project Management Dashboard using Trello API',
  ...
  {
    id: 5,
    title: 'Wireframe to Frontend Converter',
  ...
  {
    id: 6,
    title: 'API Documentation Generator from Swagger/OpenAPI Specs',
