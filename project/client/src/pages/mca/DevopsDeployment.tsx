...
const allProjects = [
  {
    id: 1,
    title: 'Dockerized Flask App with MongoDB Backend',
  ...
  {
    id: 2,
    title: 'CI/CD Pipeline for React App using GitHub Actions',
  ...
  {
    id: 3,
    title: 'Blog Hosting with Nginx on Ubuntu Server',
  ...
  {
    id: 4,
    title: 'Portfolio Deployment using Netlify and GitHub',
  ...
  {
    id: 5,
    title: 'Spring Boot App with Jenkins Deployment',
  ...
  {
    id: 6,
    title: 'Weather Forecast Web App Deployed via Docker',
