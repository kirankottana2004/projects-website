...
const allProjects = [
  {
    id: 1,
    title: 'Fitness Tracker App using Flutter',
  ...
  {
    id: 2,
    title: 'Notes App with Firebase Sync ',
  ...
  {
    id: 3,
    title: 'College Events Notification App',
  ...
  {
    id: 4,
    title: 'To-Do List App with Reminders ',
  ...
  {
    id: 5,
    title: 'Food Delivery App using Flutter and Firebase',
  ...
  {
    id: 6,
    title: 'Student Attendance App with QR Code',
